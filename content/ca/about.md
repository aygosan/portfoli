...
Entenc la feina d'infraestructura com un compromís a llarg termini. Tot ha de ser declaratiu, versionat i observable, perquè el que no es pot reproduir no es pot mantenir. Documento les decisions, automatitzo la feina repetitiva i refuso la feina manual que es pot delegar a una màquina. La meva mètrica d'èxit no és desplegar ràpid, sinó construir plataformes que siguin un plaer d'operar i que facin la vida més fàcil a qui les fa servir.
